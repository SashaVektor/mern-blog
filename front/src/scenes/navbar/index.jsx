...
import {
  Box, IconButton,
  InputBase, Typography, Select,
  MenuItem, FormControl, useTheme, useMediaQuery
} from '@mui/material'
import {
  Search, Message, DarkMode,
  LightMode, Notifications, Help, Menu, Close
...
const Navbar = () => {
  ...
  return (
    <FlexBetween padding="1rem 6%" backgroundColor={alt}>
      ...
      {!isNonMobileScreens && isMobileMenu && (
        <Box position="fixed" right="0" bottom="0" height="100%" maxWidth="500px" zIndex="10"
          minWidth="300px" backgroundColor={background}>
